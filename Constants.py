...
DATABASE_REPORTS_ATTRIBUTES = ("Data_Type", "Access_Method")
DATABASE_REPORT_FIELDS = (
    {
        NAME_KEY: "database",
        TYPE_KEY: "TEXT",
...
PLATFORM_REPORTS_ATTRIBUTES = ("Data_Type", "Access_Method")
PLATFORM_REPORT_FIELDS = (
    {
        NAME_KEY: "platform",
        TYPE_KEY: "TEXT",
        OPTIONS_KEY: ("NOT NULL",),
...
ALL_REPORT_FIELDS = (
    ...
    {NAME_KEY: "updated_on", TYPE_KEY: "TEXT", OPTIONS_KEY: ("NOT NULL",)},
    {NAME_KEY: "file", TYPE_KEY: "TEXT", OPTIONS_KEY: ("NOT NULL",)},
)
# endregion
...
MONTH_CALCULATION = (
    "COALESCE(SUM(CASE month" + " WHEN {} THEN " + "metric" + " END), 0)"
)
...
SPECIAL_REPORT_OPTIONS = {
    MajorReportType.PLATFORM: [
        ...
        (SpecialOptionType.AP, "Access_Method", ["Regular", "TDM"]),
        (
    ...
    MajorReportType.TITLE: [
        ...
        (
            SpecialOptionType.AP,
            "Section_Type",
            ["Article", "Book", "Chapter", "Other", "Section"],
        ),
        (SpecialOptionType.AP, "Access_Type", ["Controlled", "OA_Gold"]),
        (SpecialOptionType.AP, "Access_Method", ["Regular", "TDM"]),
        (
            SpecialOptionType.POS,
            "Metric_Type",
...
ACCEPTABLE_CODES = [0, 3030, 3031, 3032, 3040, 3050, 3060, 3062] + list(range(0, 1000))

# If these codes are received the retry checkbox will be checked, user can retry later
RETRY_LATER_CODES = [1010, 1011]
...
EXPORT_ALL_VENDORS_FILE_NAME = "exported_all_vendors_data.tsv"
# endregion
